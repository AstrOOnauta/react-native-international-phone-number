...
const PhoneInput = forwardRef(
  (
    ...
    if (
      ...
      // Filter out style-related props from rest
      const filteredRest = Object.entries(rest).reduce((acc, [key, value]) => {
        // Skip any props that might be style-related
        ...
        <>
          <View
            style={getContainerStyle(
              theme,
              filterStyle(phoneInputStyles?.container),
              disabled
            )}
          >
            <TouchableOpacity
              ...
              style={getFlagContainerStyle(
                theme,
                filterStyle(phoneInputStyles?.flagContainer)
              )}
            >
              <Text style={getFlagStyle(filterStyle(phoneInputStyles?.flag))}>
                {countryValue?.flag}
              </Text>
              {customCaret || (
                <View style={filterStyle(phoneInputStyles?.caret)}>
                  <View
                    style={{
                      flexDirection: 'row',
                  ...
                  >
                    <View
                      style={getCaretStyle(
                        theme,
                        filterStyle(phoneInputStyles?.caret)
                      )}
                    />
                  </View>
                </View>
              ...
              <View
                style={getDividerStyle(
                  theme,
                  filterStyle(phoneInputStyles?.divider)
                )}
              />
              <Text
                style={getFlagTextStyle(
                  theme,
                  filterStyle(phoneInputStyles?.callingCode)
                )}
              >
            ...
            <TextInput
              style={getInputStyle(theme, filterStyle(phoneInputStyles?.input))}
              placeholder={
